defmodule Typeid.Bench.Before_c9bfc3c do
  @moduledoc """
  ...
  alias Typeid.Bench.Before_c9bfc3c.{Prefix, Suffix}
  ...
  ## Example
      ...
      iex> Typeid.Bench.Before_c9bfc3c.new("user")
      {:ok, #Typeid<"user_01hzep1kb6ea1abhrg1zx021h8">}
      iex> Typeid.Bench.Before_c9bfc3c.new(nil)
      {:ok, #Typeid<"01hzevjrxwf4b831t5vshyt571">}
      iex> Typeid.Bench.Before_c9bfc3c.new("")
  ...
  ## Example
      ...
      iex> {:ok, typeid} = Typeid.Bench.Before_c9bfc3c.new("user")
      {:ok, #Typeid<"user_01hzep7s63fd5ted6f7wgqmx3m">}
      iex> Typeid.Bench.Before_c9bfc3c.to_string(typeid)
  ...
  ## Example
      ...
      iex> {:ok, typeid} = Typeid.Bench.Before_c9bfc3c.new("user")
      {:ok, #Typeid<"user_01hzep7s63fd5ted6f7wgqmx3m">}
      iex> Typeid.Bench.Before_c9bfc3c.uuid(typeid)
  ...
  ## Example
      ...
      iex> {:ok, typeid} = Typeid.Bench.Before_c9bfc3c.new("user")
      {:ok, #Typeid<"user_01hzep7s63fd5ted6f7wgqmx3m">}
      iex> Typeid.Bench.Before_c9bfc3c.valid?(typeid)
      true
      iex> Typeid.Bench.Before_c9bfc3c.valid?("user_01hzep7s63fd5ted6f7wgqmx3m")
      true
      iex> Typeid.Bench.Before_c9bfc3c.valid?("user_01hzep7s63fd5ted6f7wgqmx3")
      false
  """
  ...
  ## Example
      ...
      iex> Typeid.Bench.Before_c9bfc3c.parse("user_01hzep7s63fd5ted6f7wgqmx3m")
      {:ok, #Typeid<"user_01hzep7s63fd5ted6f7wgqmx3m">}
      iex> {:ok, typeid} = Typeid.Bench.Before_c9bfc3c.parse("01hzep7s63fd5ted6f7wgqmx3m")
  ...
  import Typeid.Bench.Before_c9bfc3c.Macros, only: [defextension: 2]
  ...
  defextension Ecto.ParameterizedType do
    ...
    def cast(%__MODULE__{} = typeid, %{type: type}) do
      if typeid.prefix == type do
        {:ok, Typeid.Bench.Before_c9bfc3c.to_string(typeid)}
      else
        :error
      end
    end
    ...
    def autogenerate(%{type: type}) do
      {:ok, typeid} = Typeid.Bench.Before_c9bfc3c.new(type)
      typeid
    end
    ...
    def load(value, _loader, %{type: type}) when byte_size(value) > 27 do
      case Typeid.Bench.Before_c9bfc3c.parse(value) do
    ...
    def load(value, _loader, %{type: type})
        when type == nil and byte_size(value) == 26
        when type == "" and byte_size(value) == 26 do
      if Typeid.Bench.Before_c9bfc3c.Suffix.valid?(value) do
        {:ok, value}
      else
        :error
      end
  ...
  defimpl String.Chars do
    def to_string(typeid), do: Typeid.Bench.Before_c9bfc3c.to_string(typeid)
  end
  ...
  defimpl Inspect do
    ...
    def inspect(typeid, _opts) do
      concat(["#Typeid<\"", Typeid.Bench.Before_c9bfc3c.to_string(typeid), "\">"])
    end
  end
  ...
  defextension Jason do
    defimpl Jason.Encoder do
      def encode(typeid, opts) do
        Jason.Encode.string(Typeid.Bench.Before_c9bfc3c.to_string(typeid), opts)
      end
    end
  end
end
